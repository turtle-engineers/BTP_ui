...
//             tag += `<td class="xday"><div class="day ` + dateColor + `">` + dateNum + `</div></td>`;
//             count++;

//         }else if(count%7===2||count%7===4){
//             tag += `<td class="Ahalf"><div class="day ` + dateColor + `">` + dateNum + `</div></td>`;
//             count++;
//         }else{
//             tag += `<td class="pickday"><div class="day ` + dateColor + `">` + dateNum + `</div></td>`;
//             count++;
//         }
//         //7일이 끝나면 tr태그 닫기
//         if (count % 7 === 0) {
