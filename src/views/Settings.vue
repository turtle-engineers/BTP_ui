        ...
        <section class="profile-container">
          <div id="picture">
            ...
            <button class="profile-pic-wrap" @click="selectUploadFile()">
              <img class="profile-edit" src="../assets/icon/profile-pic-put-icon.png" alt="프로필 이미지 수정 버튼" />
              <div id="profile-pic">
                <img :src="results.picture" alt="현재 프로필 이미지" />
              </div>
            </button>
...
export default {
  ...
  methods: {
    ...
    async putUser() {
      ...
      await axios.put('http://127.0.0.1:3000/user/info', this.newData).then((res) => {
